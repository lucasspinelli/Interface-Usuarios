class UserController  {
    ...
    getValues(formEl){ // Passei o parâmetro "FormEl " para não ficar preso a somente um atributo e poder reutilizar o método

        let user = {};
        let isValid = true;

        [...formEl.elements].forEach(function(field, index){ //... = Spread
    ...
    selectAll(){
       ...
       ajax.open('GET', '/users'); // PEGANDO INFORMALÇOES DE /USERS
    ...
    addLine(dataUser){
        ...
        getTr(dataUser, tr = null){
            ...
            tr.dataset.user = JSON.stringify(dataUser);// passamos objetos e transforma em string em JSON
     ...
     `;
        ...
        addEventsTr(tr){
            ...
            tr.querySelector(".btn-delete").addEventListener("click", e=>{ // Evento Botão "Excluir"
            ...
            tr.querySelector(".btn-edit").addEventListener("click", e=>{ //evento ao clicar "editar"
            ...
            for (let name in json){
             ...
             if(field){
                  ...
                  switch (field.type){
                      ...
                      case 'file':
                          continue;// continue = ignora tudo pra baixo e vai pro próximo
                      break;
